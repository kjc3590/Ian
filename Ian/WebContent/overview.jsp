				...
				<div class="wdwd">
					...
					<ul class="nav nav-tabs mb-45" role="tablist">
						<li role="presentation" class="active interval "><a
							href="#OVERVIEW" aria-controls="home" role="tab"
							data-toggle="tab">OVERVIEW</a></li>
						<li role="presentation" class="interval"><a
							href="#INTRODUCTION" aria-controls="profile" role="tab"
						...
						<li role="presentation" class="interval"><a
							href="#OGANIZATION" aria-controls="profile" role="tab"
							data-toggle="tab">OGANIZATION</a></li>
						...
						<div class="tab-con">
							<div class="tab-title">
								...
								<p class="tab-subtitle">
									<img class="" src="assets/images/stroke.png" alt="...">OVERVIEW
								</p>
							</div>
					...
					<div role="tabpanel" class="tab-pane" id="INTRODUCTION">
						...
						<div class="tab-con">
							<div class="tab-title">
								...
								<p class="tab-subtitle">
									<img class="" src="assets/images/stroke.png" alt="...">INTRODUCTION
								</p>
							</div>
					...
					<div role="tabpanel" class="tab-pane" id="HISTORY">
						<div class="tab-con">
							<div class="tab-title">
								...
								<p class="tab-subtitle">
									<img class="" src="assets/images/stroke.png" alt="...">HISTORY
								</p>

							</div>
							<ul class="history-content" role="tablist">
								<li role="presentation" class="active"><a data-toggle="tab"
									role="tab" href="#home">1985-2000</a></li>
								<li role="presentation"><a data-toggle="tab" role="tab"
									href="#menu1">2001-2010</a></li>
								<li role="presentation"><a data-toggle="tab" role="tab"
									href="#menu2">2011-2017</a></li>
							</ul>

							<div class="tab-content">
								<div id="home" class="tab-pane ttr active">

									<div class="history-datebox">


										<p>
											<img class="" src="assets/images/stroke.png" alt="...">2011.5.18
										</p>


										<span>주택건설업 등록<br> (서울-주택 2011-0083)<br>
											Acquired license for housing construction
										</span>
									</div>
									<div class="history-datebox">
								...
								<div id="menu1" class="tab-pane ttr">
									...
									<div class="history-datebox">
										...
										<span>주택건설업 등록<br> (서1울-주택 2011-0083)<br>
											Acquired license for housing construction
										</span>
									</div>
									<div class="history-datebox">
								...
								<div id="menu2" class="tab-pane ttr">
									...
									<div class="history-datebox">
										...
										<span>주택건설업 등록<br> (서2울-주택 2011-0083)<br>
											Acquired license for housing construction
										</span>
									</div>
									<div class="history-datebox">
					...
					<div role="tabpanel" class="tab-pane" id="OGANIZATION">
						<div class="tab-con">
							<div class="tab-title">
								...
								<p class="tab-subtitle">
									<img class="" src="assets/images/stroke.png" alt="...">OGANIZATION
								</p>
							</div>
							<ul class="oga-ul" role="tablist">
								<li role="presentation" class="active"><a data-toggle="tab"
									role="tab" href="#architect">Architect</a></li>
								<li role="presentation"><a data-toggle="tab" role="tab"
									href="#design">design</a></li>
								<li role="presentation"><a data-toggle="tab" role="tab"
									href="#develope">develope</a></li>
							</ul>


							<div class="tab-content">
								<div id="architect" class="tab-pane ttr active">
									<div class="oga-content">
										<span>하하하하하하하핳하하하핳하하하하하하</span>
									</div>

								</div>
								<div id="design" class="tab-pane ttr">
									<div class="oga-content"></div>


								</div>
								<div id="develope" class="tab-pane ttr ">
									<div class="oga-content"></div>
					...
					<div role="tabpanel" class="tab-pane" id="LICENCE">
						<div class="tab-con">
							<div class="tab-title">
								...
								<p class="tab-subtitle">
									<img class="" src="assets/images/stroke.png" alt="...">LICENCE
								</p>
							</div>
